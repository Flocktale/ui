              ...
              child: NotificationListener<ScrollNotification>(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      BuiltActiveJoinRequests _joinRequests =
                          searchInput.text.isNotEmpty
                              ? joinRequestsFiltered
                              : joinRequests;
                      return InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (_) => ProfilePage(
                                    userId: _joinRequests
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            ...
                            trailing: ButtonTheme(
                              ...
                              child: RaisedButton(
                                onPressed: () async {
                                  final resp = await acceptJoinRequest(
                                      _joinRequests
                                          ?.activeJoinRequestUsers[index]
                                          ?.audience
                                          ?.userId);
                                  ...
                                  final allRequests = _joinRequests
                                      .activeJoinRequestUsers
                                      .toBuilder();

                                  allRequests.removeAt(index);
                                  _joinRequests = _joinRequests.rebuild((b) =>
                                      b..activeJoinRequestUsers = allRequests);
