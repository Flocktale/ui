...
class _ProfileImagePageState extends State<ProfileImagePage> {
  ...
  uploadImage() async{
    ...
    final response = await service.createNewUser(newUser, authorization: authToken);
    ...
    if(response.isSuccessful && image!=null){
      ...
      final resp = await service.uploadAvatar(userId, newImage, authorization: authToken);
      ...
      Fluttertoast.showToast(msg: "User created with default image");
      Navigator.of(context).pushNamed('/');
    }
    else {
      Fluttertoast.showToast(msg: "Some error occured "+response.bodyString);
    }
