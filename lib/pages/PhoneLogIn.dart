                ...
                children: [
                  Stack(
                    children: <Widget>[
                      Container(
                        padding:
                            EdgeInsets.fromLTRB(15, size.height / 10, 0, 0),
                        child: Text(
                          'Hello',
                          style: TextStyle(
                              fontFamily: 'Lato',
                          ...
                          child: InkWell(
                            onTap: () async {
                              final diff = DateTime.now()
                                  .difference(_resendingTime)
                                  .inSeconds;
                              if (diff < 30) {
                                await Fluttertoast.cancel();
                                Fluttertoast.showToast(
                                    msg:
                                        'Please Wait for ${30 - diff} seconds');
                                return;
                              }
                              ...
                              Fluttertoast.showToast(msg: 'OTP is sent again.');
                            },
                            child: Text(
                              'Resend OTP',
                              style: TextStyle(
                            ...
                            child: RaisedButton(
                              onPressed: () async {
                                if (!_formKey.currentState.validate()) {
                                  ...
                                  final resp = await Provider.of<UserData>(
                                          context,
                                          listen: false)
                                      .sendOTP(_dialCode, phoneNumber);
