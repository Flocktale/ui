        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Positioned(
              top: size.height/8,
              left: (size.width/4),
              child: Image.network(widget.Clubs[widget.index].clubAvatar,height: size.height/4,width: size.width/2,fit: BoxFit.cover,),
            ), //Club Image
            Positioned(
              top: size.height/8,
              right: 10,
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) => ProfilePage(userId: widget.Clubs[widget.index].creator.userId)
                      ));
                    },
                    child: CircleAvatar(
                      backgroundColor: Colors.white,
                      backgroundImage: NetworkImage(widget.Clubs[widget.index].creator.avatar),
